...
public class Parameter {
    ...
    @Id
    @SequenceGenerator(name = "ADM_PARAM_SEQ", sequenceName = "ADM_PARAM_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ADM_PARAM_SEQ")
