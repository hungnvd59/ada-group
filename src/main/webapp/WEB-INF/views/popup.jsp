	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button style="border-radius: 10px; color: #282424; border-color: #282424" type="button" class="btn" data-dismiss="modal"><spring:message code="message.modal.cancel"/></button>
                                <a class="btn"><i class="fa fa-check"></i> <spring:message code="label.button.delete"/></a>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="popup-message" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
                            <button style="border-radius: 10px; color: #282424; border-color: #282424" type="button" class="btn" data-dismiss="modal"><i class="fa fa-times"></i> <spring:message code="label.button.close"/></button>
			</div>
		</div>
	</div>
</div>
