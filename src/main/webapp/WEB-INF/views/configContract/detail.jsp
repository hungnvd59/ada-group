...
<script src="<%=request.getContextPath()%>/assets/project/configContract/detail.js"></script>
<style>
    .control-active {
...
<section style="color: #3f3f46;" id="partnerSC" ng-app="FrameworkBase" ng-controller="partnerCtrl">
    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div>
                <a href="<%=request.getContextPath()%>/config-contract/index.html"><h3 style="font-weight: bold"><span class="fa fa-angle-left"></span> CHI TIẾT CẤU HÌNH HOA HỒNG</h3></a>
            </div>
            </div>
                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input ng-model="name" style="border-radius: 10px"
                                               ...
                                               ng-init="name = configDetail.name"
                                               class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-5">
                                        <label class="control-label color-label left">Mô tả <font color="red">*</font>
                                        </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <input ng-model="description" style="border-radius: 10px"
                                               name="description"
                                               placeholder="Mô tả"
                                               ng-init="description = configDetail.description"
                                               class="form-control"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="accordion" id="config-contract">
                        <div class="card">
                            <div class="card-header" id="config-contract-header">
                                <a class="btn btn-link configHeader" type="button" data-toggle="collapse" id="HH"
                                   data-target="#content" aria-expanded="true" aria-controls="content">
                                    <label id="hh1" style="font-weight: bold"> <i class="fa fa-chevron-down"></i> CẤU
                                        HÌNH HOA HỒNG</label>
                                    <label id="hh2" style="font-weight: bold; display: none;"> <i
                                            class="fa fa-chevron-right"></i> CẤU HÌNH HOA HỒNG</label>
                                </a>
                            </div>
                            <div id="content" class="collapse" aria-labelledby="content"
                                                            ...
                                                            <div class="col-sm-3 headerTable">
                                                                <div class="col-sm-8 input-line">
                                                                    <input ng-model="m_bl_pre_osp" class="form-control"
                                                                           ...
                                                                           type="text"/>
                                                                    <label style="float:left;"><font color="#0065FF">{{m_bl_pre_osp_value | currency:"":0}}
                                                                        VNĐ</font></label>
                                                                </div>
                                                                <div class="col-sm-4 input-line">
                                                                    <input class="form-control"
                                            ...
                                            <div class="card-header" id="headingTwo">
                                                <a class="btn btn-link collapsed configContent" type="button"
                                                   ...
                                                   aria-controls="collapseTwo">
                                                    <label id="gc1"><i class="fa fa-chevron-down"></i> Dịch vụ Gói cước</label>
                                        ...
                                        <%-- <div class="card">
                                             <div class="card-header" id="headingThree">
                                                 <button class="btn btn-link collapsed configContent" type="button"
                                                     ...
                                                     <i class="fa fa-chevron-down"></i> Dịch vụ Vietlott
                                                 </button>
                                             </div>
                    ...
                    <div class="accordion" id="to-config-contract">
                        <div class="card">
                            <div class="card-header" id="to-config-contract-header">
                                <a class="btn btn-link configHeader" type="button" data-toggle="collapse" id="DS"
                                   data-target="#to-content" aria-expanded="true" aria-controls="content">
                                    <%--                                    <i class="fa fa-chevron-down"></i> <label style="font-weight: bold">DANH SÁCH TÀI--%>
                                    <%--                                    KHOẢN ÁP DỤNG CẤU HÌNH HOA HỒNG</label>--%>
                                        ...
                                        <div class="row" style="margin: 15px">
                                            <div id="list-active" class="list-control-active">
                                                <div id="myBtnContainer" class="button-control"
                                                    ...
                                                    <button class="btnFilter control-active"
                                                            data-value="all"
                                        ...
                                        <table id="tbl" class="table table-striped table-bordered m-b-none b-light">
                                            ...
                                            <tr ng-repeat="item in listData.items track by $index">
                                                ...
                                                <td class="text-center"><label
                                                        style="border-radius: 5px;padding:1px 5px 1px 5px;background-color: #E5E7EB;text-align: center;width: auto"><span>{{item.name}}</span></label>
                                                </td>
        ...
        <footer class="panel-footer">
            <div class="row" style="padding-top: 30px">
                <div class="col-lg-12 text-center">
                    ...
                    <a ng-click="update(configDetail.id)" style="border-radius: 6px;width: 136px"
                       class="btn btn-secondary">Cập
                        nhập</a>
                </div>
            </div>
        </footer>
