...
<div class="panel-group" id="accordionAuthorityGroup" style="padding-top: 25px; color: #1F2937;">
        ...
        <div id="collapseAuthorityGroup" class="panel-collapse collapse in">
            <div class="panel-body" >
                <div class="table-responsive table-overflow-x-fix">
                    <div class="table-responsive table-overflow-x-fix">
                        <table id="tblAuthorityByGroup" class="table table-bordered table-hover m-b-none">
                            <thead>
