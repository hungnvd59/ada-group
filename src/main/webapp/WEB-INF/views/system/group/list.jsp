                ...
                <form Class="form-horizontal" role="form" theme="simple">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-4">
                                <button ng-click="search()" class="btn btn-info btn-search-common">
                                    <spring:message
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table class="table table-hover mb-sm-2">
                        ...
                        <tr style="background-color: #222222">
                            ...
                            <th class="text-center v-inherit text-white" style="width: 7%;vertical-align: middle;">
                                Tên
                                nhóm quyền
                            </th>
                            <th class="text-center v-inherit text-white" style="vertical-align: middle;width: 13%">
                                Mô
                                tả
                            </th>
                            <th class="text-center v-inherit text-white" style="vertical-align: middle;width: 7%">
                                Người
                                tạo
                            </th>
                            <th class="text-center v-inherit text-white" style="vertical-align: middle;width: 7%">
                        ...
                        <tr ng-repeat="item in listData.items track by $index">
                            ...
                            <td style="vertical-align: middle;text-align: center" class="text-left v-inherit">
                                ...
                                <img width="14px" height="14px" ng-click="redirectDetail(item.id)" title="Sửa"
                                     src="<%=request.getContextPath()%>/assets/images/icon/brush.png"
                                     style="cursor: pointer;">
                                <%--                                </sec:authorize>--%>
                            </td>
                            <td style="vertical-align: middle;" class="text-left v-inherit">{{item.groupName}}</td>
                            <td style="vertical-align: middle;" class="text-left v-in herit">{{item.description}}
                            </td>
                            <td style="vertical-align: middle;text-align: center" class="text-left v-inherit">
                                {{item.createBy}}
                            </td>
