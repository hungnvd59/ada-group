...
<div class="panel-group" id="accordionUserGroup" style="padding-top: 25px; color: #1F2937;">
        ...
        <div id="collapseUserGroup" class="panel-collapse collapse in">
            <div class="panel-body" >
                <div class="table-responsive table-overflow-x-fix">
                    <div class="table-responsive table-overflow-x-fix">
                        <table id="tblUserByGroup" class="table table-hover table-bordered m-b-none">
                            <thead>
