...
<script src="<%=request.getContextPath()%>/assets/project/history/log.user.js"></script>
        ...
        <aside>
            <section class="vbox">
                <header class="header bg-white b-b b-light">
                    <p><spring:message code="label.history.timelineuser"/>: ${user.username} -- ${user.fullName}</p>
                </header>
